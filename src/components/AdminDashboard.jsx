...
import { DELETE_CUSTOMER, GET_ALL_CUSTOMER } from '../constant/Endpoint';
  ...
  return (
    <div>
        ...
        <div className='container justify-content-center align-items-center d-flex mb-4'>    
            {customerList.length >0 && <input style={{textAlign:'center'}} type='text' placeholder='Search by name' onChange={handleSearch}/>  }
        </div>
