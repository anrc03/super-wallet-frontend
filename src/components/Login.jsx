							...
							<div className="col-md-6 p-4">
								...
								<div className="row" style={{ color: "#3a5a40" }}>
									...
									<div className="col-md-12">
										<button
											type="submit"
											className="btn float-end login-button mt-2"
								...
								>
									<button type="submit" className="btn sign-in-with">
										<img
									...
									<button type="submit" className="btn m-2 sign-in-with">
										<img
											src="src/assets/images/login/Facebook.png"
											alt="Login From Facebook"
											style={{ width: 35, marginRight: 10 }}
										/>
										Facebook
									</button>
