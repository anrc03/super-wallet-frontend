                ...
                <div className="row justify-content-between gy-5">
                    <div className="col-lg-6 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
                        ...
                        <div>
                            ...
                            <Link className="btn-book-a-table" to="/store">Store</Link>
                            </> : <></>}
                    ...
                    <div className="col-lg-5">
                        <img src="src/assets/images/hero/Hero.png" className="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300" />
                    </div>
                </div>
            </div>
        </section>
